...
WarmUpResult NormalEngine::prefillWarmUp(const EngineInitParams& params) {
    ...
    executor_.reset(new NormalExecutor(
        params, nullptr, thread_pool_, true, false, 0, mla_ops_type_, kv_cache_group_num_, kv_cache_layer_to_group_));
...
WarmUpResult NormalEngine::decodeWarmUp(const EngineInitParams& params) {
    ...
    executor_.reset(new NormalExecutor(
        params, cache_manager, thread_pool_, true, false, 0, mla_ops_type_, kv_cache_group_num_, kv_cache_layer_to_group_));
