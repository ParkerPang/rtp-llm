...
class CudaFp8VllmBlockwiseLinearNumericalTest(unittest.TestCase):
    ...
    def test_factory_rejects_ue8m0_weight_scales(self):
        ...
        with self.assertRaisesRegex(
            ValueError, "SM120 FP8_PER_BLOCK requires float32 weight scales"
        ):
            LinearFactory.create_linear(
                weight=self.weight_fp8,
                bias=None,
...
@unittest.skipIf(
    _get_cutlass_scaled_mm_blockwise_sm120_fp8() is None,
...
class CudaFp8VllmBlockwiseSM120BoundaryTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.K = 256
        self.N = 128
        self.gemm_op = _get_cutlass_scaled_mm_blockwise_sm120_fp8()
