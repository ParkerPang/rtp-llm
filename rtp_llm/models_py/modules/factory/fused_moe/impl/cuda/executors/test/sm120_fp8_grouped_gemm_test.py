...
def _make_grouped_gemm_executor_case(E, K, N, M, top_k, device="cuda"):
    ...
    model_config.expert_num = E
    model_config.moe_k = top_k
    parallelism_config = ParallelismConfig()
    parallelism_config.ep_size = 1
    config = MoEConfigAdapter(model_config, parallelism_config, MoeConfig())
...
class TestSm120Fp8GroupedGemm(unittest.TestCase):
    ...
    def test_executor_matches_fp32_reference(self):
        ...
        self.assertGreater(cosine.item(), 0.95)
    ...
    def test_siglu_alias_uses_silu_kernel(self):
        ...
        self.assertEqual(result.fused_expert_output.shape, (8, 512))
